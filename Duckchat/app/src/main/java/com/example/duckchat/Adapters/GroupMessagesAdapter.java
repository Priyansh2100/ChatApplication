package com.example.duckchat.Adapters;
...
import com.example.duckchat.databinding.DeleteDialogBinding;
import com.example.duckchat.databinding.ItemReceiveBinding;
import com.example.duckchat.databinding.ItemReceiveGroupBinding;
import com.example.duckchat.databinding.ItemSentBinding;
import com.example.duckchat.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter{
    ...
    @Override
    public int getItemViewType(int position) { //return the view type of the item
        Message message = messages.get(position);   //meaage ka object bna denge
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            if(message.getMessage().equals("photo")) { // agr vo photo h
